...
L["Refresh on Execution"] = true
L["When enabled, this variable will be recalculated every time a sequence is executed, providing real-time values without continuous background updates."] = true
